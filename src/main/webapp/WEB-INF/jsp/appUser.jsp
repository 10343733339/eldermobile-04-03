...
<div class="page-container">
	 <div class="text-c"> 
	 账号：	<input type="text" class="input-text" style="width:250px" placeholder=" 账号" id="account" name="account">
...
$(document).ready(function() {
	...
	"aoColumns" : [ //aoColumns设置列
	                ...
	                {"data": function(data)  {return '<img src="'+data.headPortrait+'" width="50px"  height="30px"/>';}, "orderable": false,'sClass': "text-c odd"},
	                {"data": "phone", "orderable": false,'sClass': "text-c odd"},
