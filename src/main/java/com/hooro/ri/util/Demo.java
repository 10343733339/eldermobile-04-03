...
public class Demo {
    public static void main(String[] args) {
       ...
       /* System.out.println(t.demoPushSingleDeviceMessage());
        ...
        System.out.println(XingeApp.pushTokenIos(2200293348L, "98aea322c1467bac2b709311d0cfad80", "测试",
        		"1f76c8229acbc15148508c549cb94f89abb691c6b691c6b691c6b691c6b691c6",
        		XingeApp.IOSENV_DEV));
        //iOS推送
